...
import com.demo.techpro.expenses.backend.controller.swagger.StatisticsControllerSwagger;
import com.demo.techpro.expenses.backend.dto.SearchCriteriaDTO;
import com.demo.techpro.expenses.backend.dto.StatsDTO;
import com.demo.techpro.expenses.backend.service.StatisticsService;
...
import static com.demo.techpro.expenses.backend.constants.ControllerEndpointConstants.STATISTICS;
...
public class StatisticsController implements StatisticsControllerSwagger {
    ...
    public StatsDTO getStatistics(
        ...
        return service.calculateStatistics(criteria);
    }
